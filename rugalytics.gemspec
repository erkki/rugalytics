...
Gem::Specification.new do |s|
  ...
  s.description = %q{Rugalytics is a Ruby API for accessing your Google Analytics Data.
}
  ...
  s.summary = %q{Rugalytics is a Ruby API for accessing your Google Analytics Data.}
